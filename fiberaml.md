...
- 2. [Opis usług](#-opis-usług)
  ...
  - 2.9. [DELETE /parties/{code}](#-delete-parties-code)
  - 2.10 [POST /transactions](#-post-transactions)
  - 2.11. [GET /transactions](#-get-transactions)
  - 2.12. [GET /transactions/{code}](#-get-transactions-code)
  - 2.13. [GET /transactions/pdf/{code}](#-get-transactions-pdf-code)
  - 2.14. [DELETE /transactions/{code}](#-delete-transactions-code)
  - 2.15. [POST /events](#-post-events)
  - 2.16. [GET /events](#-get-events)
  - 2.17. [GET /events/{code}](#-get-events-code)
  - 2.18. [POST /comments](#-post-comments)
  - 2.19. [GET /alerts](#-get-alerts)
  - 2.20. [GET /alerts/{code}](#-get-alerts-code)
